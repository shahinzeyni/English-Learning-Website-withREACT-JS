        ...
        <div className="ticket-top">
          <div className="ticket-top__right">
            <a className="ticket-top__link" href="#">
              <i className="fa fa-angle-right ticket-top__icon" />
            </a>
          </div>
