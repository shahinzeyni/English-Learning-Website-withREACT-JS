...
import "./CourseBoxSwiper.css";

export default function CourseBoxSwiper(props) {
  ...
  return (
    ...
    <div className="col-">
      <div className="course-box courseBoxSwiper">
        <Link
          to={`/course-info/${props.shortName}`}
          className="course_box_Images"
        >
          <img
        ...
        <div className="course-box__main">
          ...
          <div className="course-box__rating-teacher">
            ...
            <div className="course-box__rating">
              <span className="course-box__starNumber">5.0</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="1em"
                height="1em"
          ...
          <div className="course-box__status">
            ...
            <span className="course-box__price">
              {props.price === 0 ? (
                ...
                <>
                  <p className="course_box_price_tomanNumber">
                    {props.price.toLocaleString()}
                  </p>
                  <p className="course_box_price_toman">
                    <svg
                      className="ms-4"
                      width="15"
                      height="15"
        ...
        {props.price !==0  && props.discount !==0 && props.discount !==  undefined   && (
